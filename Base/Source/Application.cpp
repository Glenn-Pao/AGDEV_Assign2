...
void Application::Init()
{
	...
	m_window = glfwCreateWindow(m_window_width, m_window_height, "The Best Game EVER", NULL, NULL);
	...
	theGSM->Init( "The Best Game EVER", 800, 600 );
	theGSM->ChangeState( CSplashState::Instance() );

	//Use the gsm to update the sound
}
